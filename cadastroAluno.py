...
class TelaAluno:
        ...
        def janela_aluno(self):
                ...
                layout = [
                        [sg.Text('CPF', size=(15,1), background_color="#fff", text_color="black"), sg.Input(key="-CPF-", font=('Helveltica', 15),  border_width=(0), pad=(20,5), background_color="#fff" , size=(20,1),do_not_clear=False), sg.Button('Buscar', key="-BUSCAR-CPF-", border_width="0")],
                ...
                janela = sg.Window('Cadastro de Cliente', size=(960 ,540), margins=(150,70),default_element_size=(12, 1),layout=layout, background_color="#fff", finalize=True)
                janela.set_min_size((960, 540))
               
        

                janela['-CPF-'].Widget.configure(highlightbackground="green",highlightthickness = 1)
