...
top_banner = [[sg.Text('Dashboard'+ ' '*64, font='Any 20', background_color=DARK_HEADER_COLOR),
               sg.Text('0 de Feveiro de 2022', font='Any 20', background_color=DARK_HEADER_COLOR)]]

top  = [[sg.Text('O Relogio esta aqui', size=(50,1), justification='', pad=BPAD_TOP, font='Any 20')],
